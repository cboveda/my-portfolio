        ...
        <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap xl:w-[1280px]">
          ...
          >
            ...
            <p className="leading-relaxed mb-5">
              I am seeking a remote or local software engineering position with
              a path towards team leadership.
            </p>
            <div className="relative mt-2 mb-4">
              ...
              <input
                ...
                id="name"
                name="name"
                className="w-full bg-background border border-header focus:border-primary focus:ring-2 focus:ring-primary text-base outline-none text-main py-1 px-3 leading-8 transition-colors duration-400 ease-in-out"
            ...
            <div className="relative mb-4">
              ...
              <textarea
                id="message"
                name="message"
                className=" h-24 w-full bg-background border border-header focus:border-primary focus:ring-2 focus:ring-primary text-base outline-none text-main py-1 px-3 leading-8 transition-colors duration-400 ease-in-out"
